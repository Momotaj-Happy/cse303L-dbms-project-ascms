	...
	<div class="section center" style="padding: 20px;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                <a href="product-edit.php?id=<?php echo $key['product_id']; ?>"><span class="new badge blue" data-badge-caption="">Edit</span></a>
                <a href="../backends/admin/product-delete.php?id=<?php echo $key['product_id']; ?>"><span class="new badge red" data-badge-caption="">Delete</span></a>
            </td>
          </tr>
