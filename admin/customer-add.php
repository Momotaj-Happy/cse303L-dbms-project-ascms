    ...
    <div class="section center" style="padding: 40px;">
        <form action="../backends/admin/customer-add.php" method="post">
            ...
            <div class="row">
                ...
                <div class="col s6">
                    <div class="input-field">
                        <input id="customer_type" name="customer_type" type="text" class="validate" style="color: white; width: 70%" required>
                        <label for="customer_type" style="color: white;"><b>Customer Type (e.g. Retailer) :</b></label>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col s6">
                    <div class="input-field">
                        <input id="contact_info" name="contact_info" type="text" class="validate" style="color: white; width: 70%" required>
                        <label for="contact_info" style="color: white;"><b>Contact Info :</b></label>
                    </div>
                </div>
                <div class="col s6">
                    <div class="input-field">
                        <input id="address" name="address" type="text" class="validate" style="color: white; width: 70%" required>
            ...
            <div class="row">
                <div class="col s12">
                    ...
                    <div class="section right" style="padding: 15px 20px;">
                        <button type="submit" class="waves-effect waves-light btn">Add Customer</button>
                    </div>
                </div>
            </div>
        </form>
